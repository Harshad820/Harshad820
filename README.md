...
<p align="left">
🌍 <a href="https://maps.app.goo.gl/N8esLrotSkbGB7fbA"> Pune, Maharashtra, India</a><br>
...
⚡ My approach combines analytical thinking with technical skills, allowing me to work across the complete data pipeline—from data extraction and processing to visualization and storytelling.

🌱 Currently, I am continuously improving my skills in advanced analytics, business intelligence, and scalable data solutions to grow as a data professional.

🎯 My goal is to leverage data to create impactful, data-driven solutions that add real value to businesses and users.
